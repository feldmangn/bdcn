...
time.sleep(3)
while (True):
    screen = cv2.imread('/home/pc/Documents/BiDirectionalCascadeEdge/images/wrongImages/bdcn/26.jpg')
    ...
    cv2.imshow('Lines detected', cv2.cvtColor(combo_image, cv2.COLOR_BGR2RGB))
    cv2.waitKey(0)
